...
function Average_Speed_option($value)
{
    echo '<option value = "'.$value .'"';
    if (isset($_POST['Average_Speed']) && ($_POST['Average_Speed'] == $value))
    {
         echo ' selected="selected"';
    }
      echo ">".$value." mph </option>'"; 
}
...
<form action="calculator.php" method="post">
    ...
    <p>Average Speed limit:
      <select name="Average_Speed">
		...
		<?php
          Average_Speed_Option('35');
          Average_Speed_Option('45');
          Average_Speed_Option('55');
          Average_Speed_Option('65');
        ?>
	</select>
    </p>
